...
useEffect(() => {
  ...
  const handleRedPillClick = async (): Promise<void> => {
    ...
    try {
      ...
      }).then(response => response.json()).then(data => data.roast)
  ...
  return (
    ...
    <div className="flex flex-col items-center justify-center min-h-screen bg-gray-900 text-white p-6 font-sans">
        ...
        {!isLoggedIn ? (
          ...
          <div className="bg-gray-800 p-8 rounded-xl shadow-2xl animate-fade-in">
            ...
            <div className="flex flex-col sm:flex-row justify-center items-center gap-4 sm:gap-6 mb-8">
              {/* Red Pill Button - Slightly toned down red */}
              <button
                ...
                className={`px-8 py-3 w-full sm:w-auto text-lg font-bold rounded-full transition duration-300 ease-in-out transform hover:scale-105 ${
                  isProcessing
                    ...
                    : 'bg-red-700 hover:bg-red-600 text-white shadow-lg hover:shadow-xl' // Changed to 700/600
                }`}
              ...
              {/* Blue Pill Button - Slightly toned down blue */}
              <button
                ...
                disabled={isProcessing}
                 className={`px-8 py-3 w-full sm:w-auto text-lg font-bold rounded-full transition duration-300 ease-in-out transform hover:scale-105 ${
                  isProcessing
                    ...
                    : 'bg-blue-700 hover:bg-blue-600 text-white shadow-lg hover:shadow-xl' // Changed to 700/600
                }`}
            ...
            {resultText && !isProcessing && !error && (
              <div className={`my-6 p-6 rounded-lg shadow-inner animate-fade-in ${resultType === 'roast' ? 'bg-red-900 border border-red-700' : 'bg-blue-900 border border-blue-700'}`}>
      ...
      <footer className="mt-12 text-center text-gray-500 text-sm">
        <p>&copy; {new Date().getFullYear()} Roast My Playlist. Choose wisely.</p>
